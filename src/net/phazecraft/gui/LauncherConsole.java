...
import net.phazecraft.log.ILogListener;
import net.phazecraft.log.LogEntry;
import net.phazecraft.log.LogLevel;
import net.phazecraft.log.LogSource;
import net.phazecraft.log.LogType;
import net.phazecraft.log.LogWriter;
import net.phazecraft.log.Logger;
import net.phazecraft.tools.PastebinPoster;
